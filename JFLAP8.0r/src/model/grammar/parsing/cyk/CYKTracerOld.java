...
import jflap.model.grammar.CNFConverter;
import jflap.model.grammar.Grammar;
import jflap.model.grammar.LambdaProductionRemover;
import jflap.model.grammar.Production;
import jflap.model.grammar.UnitProductionRemover;
import jflap.model.grammar.UselessProductionRemover;
import jflap.util.*;
import jflap.view.grammar.GrammarInputPane;
import jflap.view.grammar.transform.ChomskyPane;
import jflap.view.grammar.transform.LambdaController;
import jflap.view.grammar.transform.LambdaPane;
import jflap.view.grammar.transform.UnitController;
import jflap.view.grammar.transform.UnitPane;
import jflap.view.grammar.transform.UselessController;
import jflap.view.grammar.transform.UselessPane;

import JFLAPold.environment.GrammarEnvironment;
...
public class CYKTracerOld {
	...
	public CYKTracerOld(Grammar grammar, ArrayList<Production> trace) {
