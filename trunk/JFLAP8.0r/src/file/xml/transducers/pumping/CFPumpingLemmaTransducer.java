 ...
 * {@link jflap.model.pumping.ContextFreePumpingLemma} objects.
 * 
 * @author Jinghui Lim
 * @see jflap.view.pumping.PumpingLemmaChooser
 *
 */
public class CFPumpingLemmaTransducer extends PumpingLemmaTransducer<ContextFreePumpingLemma> 
{
    /**
    ...
    public ContextFreePumpingLemma fromStructureRoot(Element root) 
    {
    ...
    protected void readCases(Element root, ContextFreePumpingLemma pl)
    {
    ...
    public Document toDOM(ContextFreePumpingLemma structure) 
    {
