...
//		System.out.println("Strings3: "+UtilFunctions.createDelimitedString(gen2.generateStringsOfLength(5), "\n"));
		...
		Grammar gram = (Grammar) codec.decode(new File(System.getProperties().getProperty("user.dir") +"/filetest/LL1grammar.jff"));
		StringGenerator LLgen = new StringGenerator(gram);
		System.out.println("LL: "+UtilFunctions.createDelimitedString(LLgen.generateContextFreeStrings(10), "\n"));
	}
