 ...
 * 
 * @see LSystemInputView.lsystem.LSystemInputPane
...
public class LSystemInputEvent extends EventObject {
	 ...
	 */
	public LSystemInputEvent(LSystemInputView input) {
		super(input);
	}
	 ...
	 */
	public LSystemInputView getInputPane() {
		return (LSystemInputView) getSource();
	}
}
