...
public class Renderer {
	...
	public Renderer() {
		...
		handlers.put(JFLAPPreferences.getDrawCommand().toString(), new MoveHandler(true, true));
		handlers.put(JFLAPPreferences.getForwardCommand().toString(), new MoveHandler(false, true));
		handlers.put(JFLAPPreferences.getRightYawCommand().toString(), new TurnHandler(true));
		handlers.put(JFLAPPreferences.getLeftYawCommand().toString(), new TurnHandler(false));
		handlers.put(JFLAPPreferences.getPitchDownCommand().toString(), new PitchHandler(true));
		handlers.put(JFLAPPreferences.getPitchUpCommand().toString(), new PitchHandler(false));
		handlers.put(JFLAPPreferences.getRightRollCommand().toString(), new RollHandler(true));
		handlers.put(JFLAPPreferences.getLeftRollCommand().toString(), new RollHandler(false));
		handlers.put(JFLAPPreferences.getPushCommand().toString(), new PushTurtleHandler());
		handlers.put(JFLAPPreferences.getPopCommand().toString(), new PopTurtleHandler());
		handlers.put(JFLAPPreferences.getIWidthCommand().toString(), new WidthChangeHandler(true));
		handlers.put(JFLAPPreferences.getDWidthCommand().toString(), new WidthChangeHandler(false));
		handlers.put(JFLAPPreferences.getBeginPolygonCommand().toString(), new BeginPolygonHandler());
		handlers.put(JFLAPPreferences.getEndPolygonCommand().toString(), new ClosePolygonHandler());
		handlers.put(JFLAPPreferences.getYawCommand().toString(), new ReverseHandler());
		handlers.put(JFLAPPreferences.getIColorCommand().toString(), new HueChangeHandler(false, true));
		handlers.put(JFLAPPreferences.getDColorCommand().toString(), new HueChangeHandler(false, false));
		handlers.put(JFLAPPreferences.getIPolyColorCommand().toString(), new HueChangeHandler(true, true));
		handlers.put(JFLAPPreferences.getDPolyColorCommand().toString(), new HueChangeHandler(true, false));
	 ...
	 *             not set
	 */
	public Image render(SymbolString symbols, Map<String, String> parameters, Matrix matrix,
	...
	private Stack<Turtle> turtleStack = new Stack<Turtle>();
